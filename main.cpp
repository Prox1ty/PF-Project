    ...
    do
    {
        ...
        case 1:
        {
            ...
            do {
                ...
                cout << "Enter Rollnumber (e.g 25L-1234 all uppercase): ";
                getline(cin, rollNum);
            ...
            // section
            do {
                cout << "Enter Student Section: (e.g. BCS-1F)";
                getline(cin, section);
        ...
        case 2:
        {
            ...
            if (dataChoice == 1) {
                ...
                string rNum;
                do {
                cout << "Enter Roll Number of the Required Student (e.g 25L-1234 all uppercase): ";
                cin >> rNum;
    ...
    if (choice == 1) {
        ...
        if (choice == 1) {
            ...
            if (choice == 3) {
                ...
                string newRollNum;
                do{
                    cout << "Enter new Roll Number: (e.g 25L-1234 all uppercase)";
           ...
           displayLine();
            ...
            cin.ignore();
            beginQuery:
            cout << "Enter Roll Number of student whose data you want deleted (e.g 25L-1234 all uppercase): ";
            string rNum;
            getline(cin, rNum);
        ...
        cin.ignore();
        changeQuery:
        cout << "Enter Roll Number of student whose marks you want to change (e.g 25L-1234 all uppercase): ";
        string rNum;
        getline(cin, rNum);
        if (!validateRollNum(rNum)) {
            cout << "Invalid rollNumber" << endl;
